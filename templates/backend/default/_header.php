...
<head>
    ...
    <title><?php echo (isset($GLOBALS['Site']) ? $GLOBALS['Site']->get_Valeur('titre') : "MyERP"); ?></title>
	...
	<!-- Remodal -->
	<link rel="stylesheet" href="/templates/<?php echo $_SESSION['template']; ?>/assets/plugin/modal/remodal/remodal.css">
	<link rel="stylesheet" href="/templates/<?php echo $_SESSION['template']; ?>/assets/plugin/modal/remodal/remodal-default-theme.css">
