        ...
        <ul class="menu js__accordion">
            ...
            <?php if (isset($_SESSION['id'])) { ?>
                ...
                <li>
                    ...
                    <i class="menu-icon <?php if (isset($personnalisationMenu['icone'])) { echo $personnalisationMenu['icone']; } else { echo 'fa fa-folder-open'; }?>"></i> <?php echo $personnalisationMenu['titre']; ?>
                    </a>
                ...
                <?php } ?>
                <li>
                    <a class="waves-effect parent-item js__control" href="#"><i class="menu-icon fa fa-cog"></i><span>CONFIGURATION</span></a>
                    <ul class="sub-menu js__content">
                        <li>
                            <a href="index.php?module=parametre&rubrique=Affichage"><i class="menu-icon fa fa-cog"></i><span>Affichage</span></a>
                        </li>
                        <li>
                            <a href="index.php?module=parametre&rubrique=Users"><i class="menu-icon fa fa-cog"></i><span>Utilisateurs</span></a>
                        </li>
                        <li>
                            <a href="index.php?module=parametre&rubrique=Configuration"><i class="menu-icon fa fa-cog"></i><span>Paramètres</span></a>
                     </li>
                    </ul>
                </li>
