    ...
    <script>
        $(function() {
          ...
          $(document).ready(function() {
            // On active la vérification du formulaire pour tous le site
            controleFormulaire();

            // Scripts variables en fonction des pages         
            <?php
              // On désactive la fonction F5 si cela est paramétré dans la configuration générale
